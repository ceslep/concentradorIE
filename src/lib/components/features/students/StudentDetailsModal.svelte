...
{#if showModal}
  ...
  >
    <div
      ...
      class="relative w-full max-w-4xl max-h-[90vh] flex flex-col rounded-lg shadow-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 overflow-hidden"
    >
      <!-- Header -->
      <div
        class="flex-none flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700"
      >
      ...
      <!-- Tabs Navigation -->
      <div
        class="flex-none border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900"
      >
        <nav class="-mb-px flex space-x-8 px-4" aria-label="Tabs">
          <button
            on:click={() => (activeTab = "personal")}
            class="whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm transition-colors duration-200 {activeTab ===
            "personal"
        ...
        <form on:submit|preventDefault={handleSubmit} class="space-y-6">
          {#if activeTab === "personal"}
            <div transition:fade class="space-y-4">
              ...
              >
                <legend
                  class="text-lg font-semibold text-gray-900 dark:text-white px-2"
                >
            ...
            <div transition:fade class="space-y-4">
              ...
              >
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  ...
                  <div>
                    <label for="eHED" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
                      >HED</label
                    >
                    <input
                      type="text"
              ...
              >
                ...
                <div class="mt-4">
                  <label for="eetnia" class="block text-sm font-medium text-gray-700 dark:text-gray-300"
